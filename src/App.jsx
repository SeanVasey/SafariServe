  ...
  return (
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 10, maxWidth: 440, margin: "0 auto", padding: "56px max(20px, env(safe-area-inset-right)) 100px max(20px, env(safe-area-inset-left))" }}>
        ...
        {/* ── FOOTER ──────────────────────────────────────────── */}
        <div className="fade-up fade-up-4" style={{ textAlign: "center", marginTop: 28, opacity: 0.35 }}>
          <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: 11, color: "#3D5068", letterSpacing: "0.1em" }}>
            SAFARISERVE · VASEY/AI · {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </div>
